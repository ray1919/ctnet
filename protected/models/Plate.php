 ...
 *
 * The followings are the available columns in table 'plate':
 * @property integer $id
 ...
 */
class Plate extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Plate the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'positions' => array(self::HAS_MANY, 'Position', 'plate_id'),
		);
	}
